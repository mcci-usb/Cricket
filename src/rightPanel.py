...
class RightPanel(wx.Panel):
    ...
    def update_slog_panel(self, suts):
        print("I am in right panel: ",suts)
        ...
        # for sut in suts:
        #     print("Selected SUT: ", suts[sut])
        #     self.slobj.append(SerialLogWindow(self, self.parent, {sut: suts[sut]}))
        # for node in nodes:
        #     print("Selected SUT: ", node)
        #     self.slobj.append(SutLogWindow(self, self.parent, {"sut": node}))
