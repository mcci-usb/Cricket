...
class ComWindow(wx.Window):
    ...
    def __init__ (self, parent, top):
        ...
        self.fst_lb = wx.ListBox(self, size=(160, 120), style=wx.LB_MULTIPLE, choices = self.dlist)
        ...
        self.btn_save = wx.Button(self, ID_BTN_CONNECT, "Save", size = (50,-1))
        ...
        # self.btn_add.Bind(wx.EVT_BUTTON, self.addingDevice)

        # self.fst_lb.Bind(wx.EVT_LISTBOX, self.connect_device)
    ...
    def ConnectDevice(self, evt):
        ...
        # self.connect_device(self)
        # self.top.store_switches()
    ...
    # def addingDevice(self, e):
    #     print("Hello")
    #     data = self.fst_lb.GetSelection()
    #     # index = 0
    #     # for j in data:
    #     ls = self.fst_lb.Append(data)
    #     print("ls:", ls)

    # def connect_device(self, evt):
    #     print("connect")
    #     # slist = self.fst_lb.GetSelections()
    #     ilist = self.fst_lb.GetItems()
    #     slist = self.fst_lb.GetSelections()
    ...
    #     self.top.switch_list.clear()
    #     for i in slist:
    #         flist.append(ilist[i])
    #         self.top.switch_list.append(ilist[i])
    #         # self.top.switch_list = self.addswitchlist
    #     print("Vinay selected: ", self.top.switch_list)
            
        # slist = print ("You selected: " + self.fst_lb.GetStringSelection())
        # print("slist:", slist)
        #     # slist = self.fst_lb.GetSelection()
        #     # sl = self.switchlist.append(slist)
        #     # print("switchlist:", self.switchlist)
