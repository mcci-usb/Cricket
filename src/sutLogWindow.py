...
class TestThread(Thread):
    ...
    def stop(self):
        # print("Thread stop event Initiated")
        self.run_flg = False
...
class SutLogWindow(wx.Window):
    ...
    def __init__(self, parent, top, sut):
        ...
        # self.name = self.sut["sut"]["name"]
        # self.sutType = self.sut["sut"]["interface"]
        # self.sutSettings = self.sut["sut"][self.sutType]
        # self.sutFaultMsg = self.sut["sut"]["faultseq"]
        ...
        # self.sutConfig = sut[self.name]["settings"]
        # self.sutConfig = sut
        print("*********&&&&&&&&&&&**************")
        print(self.sutSettings)
        print("*********###########**************")
        ...
        self.hbox.Add(self.btn_config, 0, wx.ALIGN_RIGHT | 
                                         wx.ALIGN_CENTER_VERTICAL)
        self.hbox.Add(20,0,0)
        self.hbox.Add(self.btn_connect, 0, wx.ALIGN_RIGHT | 
                                         wx.ALIGN_CENTER_VERTICAL)
        self.hbox.Add(80,0,1)
        self.hbox.Add(self.btn_clear, 0, wx.ALIGN_RIGHT | 
                                         wx.ALIGN_CENTER_VERTICAL)
        self.hbox.Add(20,0,0)
        self.hbox.Add(self.btn_save, 0, wx.ALIGN_RIGHT | 
                                         wx.ALIGN_CENTER_VERTICAL)
    ...
    def save_config_data(self, cdata):
        # cdata = {"serial":{"port": "COM11", "baud": 9600, "parity": "even", "stop": 1}}
    ...
    def com_port_stopped(self):
        print("I am Serial Log, com port stopped")
        self.mySut = None
        self.mySut = sutThread.SutThread(self.com_port_stopped, self.top, self.queue, self.sut)
        self.mySut.start()
        self.con_flg = True
    ...
    def OnSutSave(self, e):
        ...
        dlg.ShowModal()
        # totline = self.scb.GetNumberOfLines()
        # print(totline)
        # if(totline > 0):
        #     instr = self.scb.GetLineText(totline-1)
        #     print(instr)
